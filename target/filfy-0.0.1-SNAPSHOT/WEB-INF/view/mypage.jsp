<html><head>
        ...
        <div class="section"><div class="container"><div class="row"><div class="col-md-12"><a class="btn btn-lg btn-primary">基本データ</a><a class="btn btn-danger btn-lg">お気に入り</a><a class="btn btn-lg btn-warning">写真</a><a class="btn btn-lg btn-success">動画<br></a><a class="btn btn-info btn-lg">設定</a></div></div></div></div><div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
